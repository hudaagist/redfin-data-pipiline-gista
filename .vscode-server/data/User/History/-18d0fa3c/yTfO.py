...
target_bucket_name = 'redfin-data-transformed-bucket-gista'
...
url_by_city = 'https://redfin-public-data.s3.us-west-2.amazonaws.com/redfin_market_tracker/state_market_tracker.tsv000.gz'
...
def transform_data(task_instance):
    ...
    df['city'] = df['city'].astype(str).str.replace(',', '', regex=False)
...
with DAG(
    ...
    load_to_s3 = BashOperator(
        ...
        bash_command = 'aws s3 mv {{ ti.xcom_pull(task_ids="task_extract_redfin_data")[0] }} s3://redfin-data-bucket-gista/'
    )
